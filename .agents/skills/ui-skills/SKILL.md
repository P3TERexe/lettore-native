---
name: ui-skills
description: Use before UI-related work to select the smallest useful UI Skills context (baseline-ui, improve-ui, fixing-accessibility, motion-performance, design-md).
license: MIT
metadata:
  author: ibelick
  version: "1.0.0"
